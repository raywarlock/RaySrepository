...
public class dynamicContentWholeThing {
    ...
    public void imgsAndTextInitially() {
        ...
        WebDriverWait waitAftr = new WebDriverWait(driver, 5);
        waitAftr.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.tagName("img")));
